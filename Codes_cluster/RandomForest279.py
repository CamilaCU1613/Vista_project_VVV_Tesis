...
cefeidas1= var1+var2+var3+var4+var5
cefeidas=var6+var7+var8+var9+var10
...
Binarias.update(d4)
Binarias.update(d5)
binarias1= v1+v2+v3+v4+v5
binarias=v6+v7+v8+v9+v10
...
Lyrae.update(da4)
Lyrae.update(da5)
lyrae1= va1+va2+va3+va4+va5
lyrae=va6+va7+va8+va9+va10
...
LPV.update(ata4)
LPV.update(ata5)
lpv1=ar1+ar2+ar3+ar4+ar5
lpv= ar6+ar7+ar9+ar10
#Ninguna
nd, No1 = data ('Datos3b278', Ks5, '3b278', d6_v[0].tolist(), d6_v[1].tolist())
nd1, No = data ('Datos3b279', Ks5, '3b279', d5_v[0].tolist(), d5_v[1].tolist())
print(len(cefeidas))
print(len(binarias))
print(len(lyrae))
print(len(lpv))
...
# Guardar el gráfico en un archivo
plt.savefig('2CrbLeon_singn.png')
...
aleatorio = [random.random() for _ in range(719)]
...
correlation_matrix.to_csv('2Catriz_correlacion.csv', index=False)
...
plt.savefig('2Cmatriz_correlacion.png')
# Mostrar la figura
plt.show()
plt.close()
