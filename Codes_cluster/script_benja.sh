...
#
#SBATCH --job-name=SAMbenja           #Nombre del job
...
#SBATCH -o SAMbenja1.o%j                 #Nombre de archivo de salida
#
########################################################################################

# ############################### Zona Carga de Modulos ################################
module load anaconda
source activate Ambiente_Daniel
########################################################################################
...
python SAM_Benja_experimental.py
