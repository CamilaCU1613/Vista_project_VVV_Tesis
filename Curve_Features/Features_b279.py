...
s_variables= archivo[6].data
s_novariables= archivo[4].data
HJD= archivo[5].data
archivo.info()
...
# Guardar el gráfico en un archivo
plt.savefig('r_value_min279.png')
...
# Guardar el gráfico en un archivo
plt.savefig('rbLeon_singn279.png')
...
aleatorio = [random.random() for _ in range(691)]
...
plt.savefig('matriz_correlacion279.png')
# Mostrar la figura
plt.show()
plt.close()
...
plt.title('Clusters file b279')
plt.legend(title='Groups')
plt.show()

plt.savefig('Clusteringb279.png')
